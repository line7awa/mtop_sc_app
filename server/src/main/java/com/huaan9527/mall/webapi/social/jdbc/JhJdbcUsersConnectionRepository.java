 ...
 * @author Keith Donald
 */
public class JhJdbcUsersConnectionRepository implements UsersConnectionRepository {
	...
	public JhJdbcUsersConnectionRepository(DataSource dataSource, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor) {
