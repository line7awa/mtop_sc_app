...
public interface CollocationRepository extends MybatisRepository<Collocation, Long> {
    ...
    CollocationDetailVo findDetailById(@Param("collocationId") String collocationId);
    ...
    CollocationVo simpleDetail(@Param("collocationId") String collocationId);
    ...
    void increaseViewCount(String collocationId);
